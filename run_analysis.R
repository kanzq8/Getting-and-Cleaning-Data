my_train_set <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\train\\X_train.txt", sep= "", header = FALSE)
my_train_act <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\train\\y_train.txt", sep= "", header = FALSE, col.names = "V562")
my_train_ref <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\train\\subject_train.txt", sep= "", header = FALSE, col.names = "V563")

my_train_set <- cbind(my_train_set, my_train_act, my_train_ref)

my_test_set <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\test\\X_test.txt", sep= "", header = FALSE)
my_test_act <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\test\\y_test.txt", sep= "", header = FALSE, col.names = "V562")
my_test_ref <- read.csv("C:\\Coursera\\Cleaning\\HAR Dataset\\UCI HAR Dataset\\test\\subject_test.txt", sep= "", header = FALSE, col.names = "V563")
